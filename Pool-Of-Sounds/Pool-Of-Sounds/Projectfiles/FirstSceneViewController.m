...
-(void) createBackground
{
	...
	colorGradient.startColor = ccc4(CCRANDOM_0_1() * 255, CCRANDOM_0_1() * 255, CCRANDOM_0_1() * 255, 255);
	colorGradient.endColor = ccc4(255, 255, 255, 255);
...
-(void) createLabel
{
	KTTrueTypeFontLabel* ttfLabel = [KTTrueTypeFontLabel trueTypeFontLabelWithText:@"Scene #1"];
